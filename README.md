...
![Lighthouse accessibility benchmark](img/lighthouse_testing.jpg "Lighthouse accessibility benchmark")
...
![Image contrast example](img/contrast_check.jpg "Image contrast example")
